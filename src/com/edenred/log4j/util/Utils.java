package com.edenred.log4j.util;
...
public class Utils {
    ...
    public static String readFromResource(String resource) throws IOException {
    	...
    	URL classDir = Utils.class.getProtectionDomain().getCodeSource().getLocation();
    	Enumeration<URL> res =Utils.class.getClassLoader().getResources(resource);
    	 while (res.hasMoreElements()) {
    		 URL url = res.nextElement();
             if(url.getPath().startsWith(classDir.toString())){
                 in = url.openStream();
             }
         }
